...
@Entity
@Table(name = "fulfillment_invoices")
@Getter
@Setter
public class FulfillmentInvoice {
    ...
    private FulfillmentInvoiceStatus status = FulfillmentInvoiceStatus.OPEN;
    ...
    @Column(name = "invoiced_at", nullable = false)
    ...
    @OrderBy("lineNo ASC")
    private List<FulfillmentInvoiceItem> items = new ArrayList<>();
    ...
    public void addItem(FulfillmentInvoiceItem item) {
        items.add(item);
